...
<body>
	...
	<div class="main_display">
		...
		<div class="mid">
			<h2>Enter the End of course score | <a href="Index.php">Close</a></h2>
				...
				<table cellspacing="0">
					...
					<?php for ($i=0; $i < sizeof($listStudent); $i++) { ?>
						...
						<tr>
							...
							<td><input type="number" name="txtCK?id=<?php echo $i ?>" placeholder="Điểm GK" style="width: 90%;border: none; outline: none;" required></td>
