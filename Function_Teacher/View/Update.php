...
<body>
	...
	<div class="main_display">
		...
		<div class="mid">
			...
			<form style="text-align: center;" method="post" action="http://localhost/project/Function_Teacher/View/Route.php?controller=store2&maLop=70DCTT21&maHp=HP01">
				<table cellspacing="0">
					<tr>
					...
					<?php for ($i=0; $i < sizeof($listStudent); $i++) { ?>
						...
						<tr>
							...
							<td><input type="number" name="txtCC?id=<?php echo $i ?>" placeholder="Điểm CC" style="width: 90%;border: none; outline: none;" required value="<?php echo $listGetData[$i][0] ?>"></td>
							<td><input type="number" name="txtGK?id=<?php echo $i ?>" placeholder="Điểm GK" style="width: 90%;border: none; outline: none;" required value="<?php echo $listGetData[$i][1] ?>"></td>
					...
					<?php } ?>
					<tr>
						<td colspan="7" style="border: none;"><input onclick="return confirm('Are you sure you want to enter points?')" type="submit" name="btnSubmit" value="input score" ></td>
					</tr>
				</table>
			</form>
		</div>
