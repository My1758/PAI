...
<body>
	...
	<div class="main_display">
		...
		<div class="mid">
			<h2>Management Schedule | <a style="color: #56A4FE;" href="http://localhost/project/Admin/Plan/View/Route.php?controller=create">Add</a></h2>
				...
				<?php 
					for ($i=0; $i < sizeof($listPlan); $i++) { ?>
						<tr>
							...
							<td><a onclick="return confirm('Do you want to delete?')" href="http://localhost/project/Admin/Plan/View/Route.php?controller=delete&maLop=<?php echo $listPlan[$i][0] ?>&maHp=<?php echo $listPlan[$i][1] ?>">Delete</a></td>
						</tr>
				<?php } ?>
