...
<body>
	<div class="header">
		...
		<div class="menu">
			<table>
				<tr>
					<td><a href="http://localhost/project/Class/View">Home page</a></td>
	...
	<div class="main_display">
		...
		<div class="mid">
			<h2>Management group | <a style="color: #56A4FE;" href="Index.php">Close</a></h2>
			<table cellpadding="5px", cellspacing="0">
				...
				<?php 
					for ($i=0; $i < sizeof($Class_search); $i++) { ?>
						<tr>
							<td><?php echo ($i+1); ?></td>
							<td><?php echo $Class_search[$i][0]?></td>
							<td><?php echo $Class_search[$i][1]?></td>
							<td><a href="http://localhost/project/Admin/Class/View/Route.php?controller=delete&maLop=<?php echo $Class_search[$i][0]?>" onclick="return confirm('Do you want to delete?')">Delete</a></td>
						</tr>
				<?php } ?>
