		...
		<div class="mid">
			<div class="insertForm" id="insertForm">
				<form method="post" action="http://localhost/project/Admin/Subject/View/Route.php?controller=store">
					...
					<table>
						<tr>
							<td colspan="4"><h3>Add Course | <a href="Index.php">Close</a></h3></td>
						</tr>
						<tr>
							<td>Id Course: </td>
							<td><input type="text" name="txtMaHp" placeholder="Mã học phần" required></td>
							<td>Name Course: </td>
							<td><input type="text" name="txtTenHocPhan" placeholder="Tên học phần" required></td>
						</tr>
						<tr>
							<td>Number of credits: </td>
							<td><input type="text" name="txtSoTinChi" placeholder="Số tín chỉ" required></td>
							<td>Direction: </td>
